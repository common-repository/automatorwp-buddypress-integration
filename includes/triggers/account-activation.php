...
class AutomatorWP_BuddyPress_Account_Activation extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User account gets activated', 'automatorwp-buddypress-integration' ),
            'select_option'     => __( 'User account <strong>gets activated</strong>', 'automatorwp-buddypress-integration' ),
            'edit_label'        => __( 'User account gets activated', 'automatorwp-buddypress-integration' ),
            'log_label'         => __( 'User account gets activated', 'automatorwp-buddypress-integration' ),
