...
class AutomatorWP_BuddyPress_Update_Avatar extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User updates avatar', 'automatorwp-buddypress' ),
            'select_option'     => __( 'User updates <strong>avatar</strong>', 'automatorwp-buddypress' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User updates avatar %1$s time(s)', 'automatorwp-buddypress' ), '{times}' ),
            'log_label'         => __( 'User updates avatar', 'automatorwp-buddypress' ),
