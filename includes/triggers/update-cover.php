...
class AutomatorWP_BuddyPress_Update_Cover extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User updates cover image', 'automatorwp-buddypress' ),
            'select_option'     => __( 'User updates <strong>cover image</strong>', 'automatorwp-buddypress' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User updates cover image %1$s time(s)', 'automatorwp-buddypress' ), '{times}' ),
            'log_label'         => __( 'User updates cover image', 'automatorwp-buddypress' ),
