 ...
 * Tags
 *
 * @package     AutomatorWP\BuddyPress\Tags
 * @since       1.0.0
 */
 ...
 * @return array
 */
function automatorwp_buddypress_get_activity_tags() {

    return array(
        'activity_id' => array(
            'label'     => __( 'Activity ID', 'automatorwp-buddypress' ),
            'type'      => 'text',
            'preview'   => 'The activity ID',
        ),
        'activity_url' => array(
            'label'     => __( 'Activity URL', 'automatorwp-buddypress' ),
            'type'      => 'text',
            'preview'   => 'The activity URL',
        ),
        'activity_content' => array(
            'label'     => __( 'Activity content', 'automatorwp-buddypress' ),
            'type'      => 'text',
